...
def register_view(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.success(
                request,
                "Регистрация прошла успешно! Добро пожаловать в личный кабинет.",
            )
            return redirect("appointments:dashboard")
    else:
...
def dashboard_view(request):
    ...
    return render(
        request, "appointments/dashboard.html", {"appointments": appointments}
    )
...
def create_appointment_view(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.success(
                request,
                "Вы успешно записались на прием! Статус записи можно отслеживать в кабинете.",
            )
            return redirect("appointments:dashboard")
    else:
